			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
						<p>Masuk Ke Akunmu!</p>
						<h1>Register Penjual Berhasil</h1>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-8 mb-5 mb-lg-0">
					<div class="form-title">
						<h2>Masuk Ke Akun Penjualan</h2>
						<p>Segera masuk ke akun Anda untuk memulai penjualan hasil tani mu di Sayurin!</p>
					</div>
				 	<div id="form_status"></div>
					<div class="contact-form">
						<form method="POST" id="fruitkha-contact" action="<?php echo site_url('Dashboard_penjual/aksi_login_penjual');?>" onSubmit="return valid_datas( this );">
							<p>
