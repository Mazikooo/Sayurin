        ...
        <div class="row">
            <div class="col-md-12">
                <div class="product-filters">
                    ...
                    <li class="active" data-filter="batang"><a href="<?php echo site_url('shop/batang');?>">Batang</a></li>
                    <li class="" data-filter="daun"><a href="<?php echo site_url('shop/daun');?>">Daun</a></li>
