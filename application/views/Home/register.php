			...
			<div class="row">
				<div class="col-lg-8 mb-5 mb-lg-0">
					<div class="form-title">
						<h2>Buat Akun</h2>
						<p>Segera daftarkan akun Anda untuk menikmati kemudahan berbelanja produk pertanian berkualitas di Sayurin!</p>
					</div>
				 	<div id="form_status"></div>
					<div class="contact-form">
						<form method="POST" id="fruitkha-contact" action="<?php echo site_url('Register/save_reg');?>" onSubmit="return valid_datas( this );">
							<p>
								<input required type="text" placeholder="Username" name="username" id="username">
								<input required type="text" placeholder="Nama Konsumen" name="nama" id="nama">
				...
				<div class="col-lg-4">
					...
					<!-- end contact form 	<div class="contact-form-box">
						...
						<div class="contact-form-box">
							...
							<div class="contact-form-box">
							<h4><i class="far fa-user"></i>Regsiter Penjual</h4>
							<p>Mulai Penjualan Hasil Tani Mu <br> Dengan Daftarkan Akunmu <a href="<?php echo site_url('Register/penjual');?>">Disini!</a> </p>
						</div>
