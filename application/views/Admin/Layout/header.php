        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?php echo site_url('Admin');?>"><i class="fa fa-users"></i> Admin <span class=""></span></a>
                  </li>

             <!--      <li><a href="<?php echo site_url('Member');?>"><i class="fa fa-group"></i> Member <span class=""></span></a>
                  </li>--> 

                  <li><a href="<?php echo site_url('Artikel');?>"><i class="fa fa-newspaper-o"></i> Artikel <span class=""></span></a>
                  </li>

             <!--       <li><a href="<?php echo site_url('Penjual');?>"><i class="fa fa-group"></i> Penjual <span class=""></span></a>
                  </li> --> 
              </div>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="<?php echo site_url('Loginadmin/logout');?>">
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  ...
                  <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item"  href="<?php echo site_url('Loginadmin/logout');?>"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                  </div>
                </li>
